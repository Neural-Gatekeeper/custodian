...
pub async fn post(new_request: Json<NewResourceHttpRequest>,
    ...
    match new_resource(new_request.clone(), generator.as_ref().as_ref(), store.as_ref().as_ref()) {
